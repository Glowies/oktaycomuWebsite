...
//Name: gould.ma
//Last modified: Fri, Mar 18, 2016 09:18:35 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 97.493640961180859 4075.2018679577891 3120.7384429859203 ;
	setAttr ".r" -type "double3" -52.538352729461948 1.8000000000000029 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 5141.5492943934314;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode transform -n "Text_Gould_1";
createNode transform -n "Char_G_1" -p "Text_Gould_1";
createNode transform -n "curve1" -p "Char_G_1";
createNode nurbsCurve -n "curveShape1" -p "curve1";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2.4000000000000004 0.82968795300221254 0
		...
		0.10000000000000001 1.5703135728999771 0
		...
		2.1500000000000004 1.6500000000000001 0
		1.9000000000000001 1.6000000000000001 0
		1.8468757152666513 1.7859388113221943 0
		1.5515632867933167 2 0
		1.3296879530022128 2 0
		0.99531395437552461 2 0
		0.60000000000000009 1.610937666895552 0
		0.60000000000000009 1.2265629053177693 0
		0.60000000000000009 0.81406271457999546 0
		0.99375143053330284 0.40000000000000002 0
		1.3125001907377738 0.40000000000000002 0
		1.4687510490577553 0.40000000000000002 0
		1.7859388113221943 0.51718776226443886 0
		1.9000000000000001 0.60156252384222175 0
		1.9000000000000001 0.75078126192111094 0
		1.9000000000000001 0.90000000000000013 0
		1.6000000000000001 0.90000000000000013 0
		1.3 0.90000000000000013 0
		;
createNode transform -n "Char_o_1" -p "Text_Gould_1";
...
createNode nurbsCurve -n "curveShape2" -p "curve2";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		15
		0.10000000000000001 0.92500038147554742 0
		0.10000000000000001 1.1515632867933165 0
		0.32656290531776916 1.5765636682688642 0
		0.74218814373998632 1.8 0
		0.99843900205996805 1.8 0
		1.393751430533303 1.8 0
		1.9000000000000001 1.3171877622644388 0
		1.9000000000000001 0.90468757152666512 0
		1.9000000000000001 0.46406347753109034 0
...
createNode nurbsCurve -n "curveShape3" -p "curve3";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		1.4000000000000001 0.60937514305333029 0
		1.4000000000000001 0.90312504768444346 0
		1.4000000000000001 1.1906263828488595 0
		1.1703135728999772 1.5 0
		1 1.5 0
		0.83125047684443443 1.5 0
		0.60000000000000009 1.1906263828488595 0
		0.60000000000000009 0.90000000000000002 0
		;
createNode transform -n "Char_u_1" -p "Text_Gould_1";
createNode transform -n "curve4" -p "Char_u_1";
createNode nurbsCurve -n "curveShape4" -p "curve4";
	setAttr -k off ".v";
	setAttr ".cc" -type "nurbsCurve" 
		2 30 1 no 3
		33 0 0 0.25625085831998168 0.25625085831998168 1.2562508583199816 2.2562508583199818
		 2.2562508583199818 3.2562508583199818 4.2562508583199818 5.2562508583199818 5.2562508583199818
		 6.3703120469977872 6.3703120469977872 6.8703120469977872 6.8703120469977872 7.7093736171511402
		 7.7093736171511402 8.7093736171511402 9.7093736171511402 10.70937361715114 10.70937361715114
		...
		1.4000000000000001 0.12812542915999084 0
		1.4000000000000001 0.25625085831998168 0
		...
		0.20000000000000001 0.43750057221332117 0
		...
		0.70000000000000018 0.9609384298466469 0
		0.70000000000000007 0.5750011444266423 0
		0.74531319142442976 0.40156252384222174 0
		0.86718852521553369 0.30000000000000004 0
		0.96093842984664679 0.30000000000000004 0
		...
		1.4000000000000001 0 0
		;
createNode transform -n "Char_l_1" -p "Text_Gould_1";
...
createNode nurbsCurve -n "curveShape5" -p "curve5";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		0.20000000000000001 0 0
		;
createNode transform -n "Char_d_1" -p "Text_Gould_1";
createNode transform -n "curve6" -p "Char_d_1";
createNode nurbsCurve -n "curveShape6" -p "curve6";
	setAttr -k off ".v";
	setAttr ".cc" -type "nurbsCurve" 
		2 20 1 no 3
		23 0 0 0.39999999999999991 0.39999999999999991 0.65156328679331654 0.65156328679331654
		 1.6515632867933165 2.6515632867933165 2.6515632867933165 3.6515632867933165 4.6515632867933165
		 ...
		 11.390624856946671 11.390624856946671
		22
		1.8 0 0
		1.6000000000000001 0 0
		1.4000000000000001 0 0
		1.4000000000000001 0.12578164339665829 0
		1.4000000000000001 0.25156328679331658 0
		1.2906263828488596 0.10468757152666515 0
		0.99531395437552461 0 0
		0.84375066758220807 0 0
		0.53750057221332115 0 0
		0.10000000000000001 0.4781261921110857 0
		0.10000000000000001 0.9062500953688869 0
		0.10000000000000001 1.3437506675822082 0
		0.50312504768444344 1.8 0
		0.81093766689555202 1.8 0
		1.0937514305333029 1.8 0
		...
		1.8000000000000003 1.2000000000000002 0
		1.8000000000000003 0 0
		;
createNode transform -n "curve7" -p "Char_d_1";
...
createNode transform -n "Trim_Char_G_1_1" -p "Trim_Text_Gould_1_1";
createNode transform -n "transform5" -p "Trim_Char_G_1_1";
	setAttr ".v" no;
createNode mesh -n "Trim_Char_G_1_1Shape" -p "transform5";
	setAttr -k off ".v";
	setAttr ".io" yes;
...
createNode transform -n "Trim_Char_o_1_1" -p "Trim_Text_Gould_1_1";
createNode transform -n "transform4" -p "Trim_Char_o_1_1";
	setAttr ".v" no;
createNode mesh -n "Trim_Char_o_1_1Shape" -p "transform4";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "Trim_Char_u_1_1" -p "Trim_Text_Gould_1_1";
createNode transform -n "transform3" -p "Trim_Char_u_1_1";
	setAttr ".v" no;
createNode mesh -n "Trim_Char_u_1_1Shape" -p "transform3";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "Trim_Char_l_1_1" -p "Trim_Text_Gould_1_1";
...
createNode mesh -n "Trim_Char_l_1_1Shape" -p "transform2";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "Trim_Char_d_1_1" -p "Trim_Text_Gould_1_1";
createNode transform -n "transform1" -p "Trim_Char_d_1_1";
	setAttr ".v" no;
createNode mesh -n "Trim_Char_d_1_1Shape" -p "transform1";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
...
createNode transform -n "polySurface1";
	setAttr ".t" -type "double3" -691.25 -1.2000023126602173 -7.62939453125e-006 ;
	setAttr ".rp" -type "double3" 691.25 1.2000023126602173 7.62939453125e-006 ;
	setAttr ".sp" -type "double3" 691.25 1.2000023126602173 7.62939453125e-006 ;
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "makeTextCurves1.p[0]" "Char_G_1.t";
connectAttr "makeTextCurves1.p[1]" "Char_o_1.t";
connectAttr "makeTextCurves1.p[2]" "Char_u_1.t";
connectAttr "makeTextCurves1.p[3]" "Char_l_1.t";
connectAttr "makeTextCurves1.p[4]" "Char_d_1.t";
connectAttr "groupId1.id" "Trim_Char_G_1_1Shape.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "Trim_Char_G_1_1Shape.iog.og[0].gco";
connectAttr "groupParts1.og" "Trim_Char_G_1_1Shape.i";
connectAttr "groupId2.id" "Trim_Char_G_1_1Shape.ciog.cog[0].cgid";
connectAttr "groupId3.id" "Trim_Char_o_1_1Shape.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "Trim_Char_o_1_1Shape.iog.og[0].gco";
connectAttr "groupParts2.og" "Trim_Char_o_1_1Shape.i";
connectAttr "groupId4.id" "Trim_Char_o_1_1Shape.ciog.cog[0].cgid";
connectAttr "groupId5.id" "Trim_Char_u_1_1Shape.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "Trim_Char_u_1_1Shape.iog.og[0].gco";
connectAttr "groupParts3.og" "Trim_Char_u_1_1Shape.i";
connectAttr "groupId6.id" "Trim_Char_u_1_1Shape.ciog.cog[0].cgid";
connectAttr "groupId7.id" "Trim_Char_l_1_1Shape.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "Trim_Char_l_1_1Shape.iog.og[0].gco";
connectAttr "groupParts4.og" "Trim_Char_l_1_1Shape.i";
connectAttr "groupId8.id" "Trim_Char_l_1_1Shape.ciog.cog[0].cgid";
connectAttr "groupId9.id" "Trim_Char_d_1_1Shape.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "Trim_Char_d_1_1Shape.iog.og[0].gco";
connectAttr "groupParts5.og" "Trim_Char_d_1_1Shape.i";
connectAttr "groupId10.id" "Trim_Char_d_1_1Shape.ciog.cog[0].cgid";
...
connectAttr "Trim_Char_G_1_1Shape.o" "polyUnite1.ip[0]";
connectAttr "Trim_Char_o_1_1Shape.o" "polyUnite1.ip[1]";
connectAttr "Trim_Char_u_1_1Shape.o" "polyUnite1.ip[2]";
connectAttr "Trim_Char_l_1_1Shape.o" "polyUnite1.ip[3]";
connectAttr "Trim_Char_d_1_1Shape.o" "polyUnite1.ip[4]";
connectAttr "Trim_Char_G_1_1Shape.wm" "polyUnite1.im[0]";
connectAttr "Trim_Char_o_1_1Shape.wm" "polyUnite1.im[1]";
connectAttr "Trim_Char_u_1_1Shape.wm" "polyUnite1.im[2]";
connectAttr "Trim_Char_l_1_1Shape.wm" "polyUnite1.im[3]";
connectAttr "Trim_Char_d_1_1Shape.wm" "polyUnite1.im[4]";
...
connectAttr "Trim_Char_o_1_1Shape.iog.og[0]" ":initialShadingGroup.dsm" -na;
connectAttr "Trim_Char_o_1_1Shape.ciog.cog[0]" ":initialShadingGroup.dsm" -na;
connectAttr "Trim_Char_u_1_1Shape.iog.og[0]" ":initialShadingGroup.dsm" -na;
connectAttr "Trim_Char_u_1_1Shape.ciog.cog[0]" ":initialShadingGroup.dsm" -na;
...
connectAttr "Trim_Char_d_1_1Shape.iog.og[0]" ":initialShadingGroup.dsm" -na;
connectAttr "Trim_Char_d_1_1Shape.ciog.cog[0]" ":initialShadingGroup.dsm" -na;
