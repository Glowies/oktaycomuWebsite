...
/*
Creates three canvas which will be used as layers for different drawing purposes and also create frame for emphasizing
...
/*
this function crates circles whose initial point and radius is given for representing molecules
*/
...
/*
this function crates circles whose initial point and radius is given for representing cells
*/
...
/*
creates a scaler for giving information about size of cells and distance between cells to do this this function takes and input
named multiple
*/
...
/*
draws counter's background which can be one of red, blue or green, which is determined by input color
*/
...
/*
draws number of molecules on counter which takes input countMolecules
*/
...
/*
shows statistics of given data when the simulation comes to end which takes inputs totalTime, totalArrive, correctData, length
which also have an animation of moving from top to the middle
*/
...
/*
when pages opening calls initRaphaelDiffusion and initCoverDiffusion functions to initialize canvases
*/
