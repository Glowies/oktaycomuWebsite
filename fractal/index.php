...
<head>
    ...
    <title>glowies - fractal creator</title>
    <meta name="description" content="A customizable simulation that creates cyclic fractals by drawing straight lines.">
</head>
...
<body>
    ...
    <div id="buttonsDiv" class="ui" style="" align="center">
        ...
        <ul class="dropdown-menu" style="cursor:pointer">
          <li id="zoomInButton" class="dropdown-item"><a>Zoom In  <span class="glyphicon glyphicon-zoom-in" aria-hidden="true" ></span></a></li>
          <li id="zoomOutButton" class="dropdown-item"><a>Zoom Out   <span class="glyphicon glyphicon-zoom-out" aria-hidden="true"></span></a></li>
          <li id="zoomResetButton" class="dropdown-item"><a>Reset Zoom   <span class="glyphicon glyphicon-search" aria-hidden="true"></span></a></li>
        </ul>
        </div>

        <div class="btn-group dropup" role="group">
        <button id="loadButton" type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Load
          <span class="caret"></span>
        </button>
        <ul class="dropdown-menu" style="cursor:pointer">
    ...
    <div id="optionsDiv" class="ui hidden-xs hidden-sm" style="width:300px">
        ...
        <div class="card-body">
          	<div id="lengthGroup" class="input-group">
              	<div class="input-group-prepend"><div class="input-group-text">Initial Line Length</div></div>
              	<input id="lengthBox" type="text" class="form-control" placeholder="5" aria-describedby="basic-addon1"/>
         	</div>
         	<br>
          	<div class="input-group">
              	<div class="input-group-prepend"><div class="input-group-text">Length Increment Rate</div></div>
              	<input id="incBox" type="text" class="form-control" placeholder="0.4" aria-describedby="basic-addon1"/>
         	</div>
         	<br>
          	<div class="input-group">
              	<div class="input-group-prepend"><div class="input-group-text">Draw Delay (ms)</div></div>
    ...
    <button id="help" type="button" class="btn btn-secondary btn-lg ui" data-toggle="modal" data-target="#tutorial" style=""> ? </button>
